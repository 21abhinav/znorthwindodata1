				...
				theLineItemsListShouldHaveTheCorrectNumberOfItems: function () {
					return this.waitFor({
						...
						check: function (oList) {
							var aEntitySet = this.getEntitySet("");
							var sObjectID = oList.getBindingContext().getProperty("EmployeeID");
							var iLength = aEntitySet.filter(function (oLineItem) {
								return oLineItem.EmployeeID === sObjectID;
							}).length;
